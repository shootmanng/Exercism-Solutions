...
namespace estate_executor {
    int assemble_account_number(int secret_modifier) {
        // Call bank_number_part functions with the secret_modifier
        ...
        // Sum up the results
        return garcia_part + zhang_part + khan_part;
    }
    int assemble_code(){
        int red_code{garcia::red::code_fragment() + khan::red::code_fragment() + zhang::red::code_fragment()};
        int blue_code{garcia::blue::code_fragment() + khan::blue::code_fragment() + zhang::blue::code_fragment()};
